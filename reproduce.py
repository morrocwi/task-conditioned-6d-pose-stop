#!/usr/bin/env python3
"""One-command numerical reproduction entry point."""
import argparse
import subprocess
import sys
...
def main():
    ...
    ap.add_argument('--profile', choices=('ci', 'quick', 'standard'), default='quick')
    args = ap.parse_args()
    ...
    run([sys.executable, 'experiments/matched_baselines.py', '--profile', args.profile, '--out-dir', 'artifacts/matched-baselines'])
    ...
    print('Matched comparator JSON: artifacts/matched-baselines/matched_baselines.json')
    print('Reduced repeated diagnostic: artifacts/replication/REPLICATION_RESULTS.md')
